...
<br><div class="row">
  ...
  <br><br> <div class="panel-group">
    <div class="panel panel-default">
      <div class="panel-heading" style="height:100px;text-align:center;font-size:40px"> Danh Mục Đề Tài Được Phân Công</div>
      <div class="panel-body" style="height:60px;font-size:20px"><a href="../JSP/detaidanghdan.jsp">Danh sách các đề tài đang hướng dẫn</a></div>
    <div class="panel panel-default"></div>
      <div class="panel-body" style="height:60px;font-size:20px"><a href="../JSP/pcongphanbien.jsp">Danh sách các đề tài được phân công phản biện</a></div>
