...
<br><div class="row">
  ...
  <br><br> <div class="panel-group">
    <div class="panel panel-default">
      <div class="panel-heading" style="height:100px;text-align:center;font-size:40px"> Danh Mục</div>
      <div class="panel-body" style="height:60px;font-size:20px"><a href="">Duyệt Hủy Đề Tài</a></div>
    <div class="panel panel-default"></div>
      <div class="panel-body" style="height:60px;font-size:20px"><a href="../JSP/duyetdangkidetai.jsp">Duyệt Đăng Kí Đề Tài</a></div>
  
    <div class="panel panel-default">
      <div class="panel-body" style="height:60px;font-size:20px"><a href="">Đăng Kí Đề Tài Của Tôi</a></div>
    </div>
    <div class="panel-body" style="height:60px;font-size:20px"><a href="">Đăng Kí Đề Tài Cho Sinh Viên</a></div>
    </div>
  </div>
  </div>
  </div>
