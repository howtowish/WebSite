...
<div class="container-fluid">
  ...
  <div class="col-md-8" style="text-align: right;font-size: 14px;color: #e74c3c;"> <h2>HỆ THỐNG QUẢN LÝ <br>VIỆN NGHIÊN CỨU KHOA HỌC </h2>
            <i class="fa fa-phone" style="font-size:20px"></i>  Tel: (+84 - 8) 38968641 - (+84 - 8) 38961333
        <br><i class="fa fa-envelope-o" style="font-size:20px"></i> Email: pro@hcmute.edu.vn</div>
</div>
...
<br><div class="row">
  ...
  <br><br> <div class="panel-group">
    <div class="panel panel-default">
      <div class="panel-heading" style="height:80px;text-align:center;font-size:30px"> Danh Mục</div>
      <div class="panel-body" style="height:60px;font-size:20px"><a href="../JSP/thongke1.jsp">Danh Sách Các Đề Tài Đã Đăng Ký</a></div>
    <div class="panel panel-default"></div>
      <div class="panel-body" style="height:60px;font-size:20px"><a href="../JSP/thongke2.jsp">Danh Sách Các Đề Tài Đã Duyệt</a></div>
  
    <div class="panel panel-default">
      <div class="panel-body" style="height:60px;font-size:20px"><a href="../JSP/thongke3.jsp">Danh Sách Các Đề Tài Bị Hủy</a></div>
    </div>
  </div>
  </div>
  </div>
